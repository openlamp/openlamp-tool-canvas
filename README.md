...
> [OpenLamp MIDI](https://github.com/openlamp/openlamp-spec-midi) answer to the club / large-rig use case.
...
- **`mirror`** — the **same** OpenLamp MIDI look/state hits **every** device (broadcast), via each one's
